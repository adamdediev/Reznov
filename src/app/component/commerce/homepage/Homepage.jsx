    ...
    return (
        <section className="homepage-commerce">
            ...
            <div className="homepage-commerce__content container">
                ...
                <svg className="hidden md:block arrow-horiz__animation" xmlns="http://www.w3.org/2000/svg" width="121" height="8" viewBox="0 0 121 8" fill="none">
                    <path
                ...
                <svg className="md:hidden arrow-vert__animation" xmlns="http://www.w3.org/2000/svg" width="8" height="42" viewBox="0 0 8 42" fill="none">
                    <path
                ...
                <button onClick={handleOpen}>заказать подбор</button>
            </div>
