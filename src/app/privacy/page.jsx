  ...
  return (
    <main className="container privacy">
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые ИП Войлочников Иван
      ...
      <p>
        ...
        <a href="https://reznov-realty.ru" target="_blank" rel="noopener noreferrer">
          https://reznov-realty.ru
        </a>
        .
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://ivan-voil.ru" target="_blank" rel="noopener noreferrer">
            https://ivan-voil.ru
          </a>
          .
        </li>
    ...
    <ul>
      <li>
        ...
        <a href="mailto:ip.voilochnikov@yandex.ru">
          ip.voilochnikov@yandex.ru
        </a>
        .
      </li>
      <li>
      ...
      <li>
        ...
        Интернет по адресу{" "}
        <a href="https://reznov-realty.ru/privacy" target="_blank">
          https://reznov-realty.ru/privacy
        </a>
        .
      </li>
    </ul>
    ...
    <p>ОГРНИП: 313667108600032</p>
    <p>ИНН: 663002766658</p>
    <p>Телефон: +7 900 629-57-77</p>
    <p>
      Email:{" "}
      <a href="mailto:ip.voilochnikov@yandex.ru">ip.voilochnikov@yandex.ru</a>
    </p>
